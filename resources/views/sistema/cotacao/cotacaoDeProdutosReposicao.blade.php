                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span>{{ $item_cotacao->produto->nome }}
                                                    ...
                                                    {{ $item_cotacao->produto->marca }}
                                                </span>
                                                <input type="hidden" name="preco_compra{{$item_cotacao->produto->id}}"
                                                    id="preco_compra{{$item_cotacao->produto->id}}"
                                                    value="{{ $item_cotacao->preco }}">
                                            </td>
                                            <td>
                                                <span>{{ $item_cotacao->fornecedor->nome }}</span>
                                                <input type="hidden" name="fornecedor_id" id="fornecedor_id"
                                                    value="{{ $item_cotacao->fornecedor->id }}">
                                            <td>
