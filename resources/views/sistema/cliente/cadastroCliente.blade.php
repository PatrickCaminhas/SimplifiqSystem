...
@section('voltar',route('cliente.read.all'))

<div class="form-group">
    <label for="cliente">Nome do cliente
        @include('partials.campoObrigatorio')
    </label>
    <input type="text" class="form-control" name="nome" id="nome" placeholder="Digite o nome do cliente"maxlength="200" required>
</div>
<div class="form-group">
    <label for="cpf">CPF/CNPJ
        @include('partials.campoObrigatorio')</label>
    </label>
    <input type="text" class="form-control" name="cpfOuCnpj" id="cpfOuCnpj" placeholder="Somente numeros" maxlength="18" required>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="email" class="form-control" name="email" placeholder="Digite o e-mail" id="email" maxlength="200">
</div>
<div class="form-group">
    ...
    <input type="text" class="form-control" name="endereco_completo" placeholder="Digite o endereço completo"
        id="endereco_completo" maxlength="255" required>
</div>
